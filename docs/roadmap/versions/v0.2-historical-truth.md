...
evidence only; regular open/close hours, weekend/session policy,
availability/revision semantics, and canonical `TradingSession` publication
remain open. See the [market-calendar evidence report](../../acceptance/2026-08-23-b3-market-calendar-evidence.md).
