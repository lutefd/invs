...
removal selection without leaking current membership backward. This accepts the
membership portion only; historical identifier and listing intervals remain open,
so the combined tracker item is intentionally unchecked. See the
