...
`1d5d2ad`; the genuine-forward gate remains unchanged. Daily-cycle input, report,
...
`1d5d2ad`, and report/log destinations are preflighted by `010cfc0`. The forward
capture boundary
...
`010cfc086c12b384b673cd85908b38d6cc00e0ec`; its daily-cycle preflight also checks
report and log destinations before execution.
