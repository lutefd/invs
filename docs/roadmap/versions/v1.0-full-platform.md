...
`e1ecd4e`; the genuine-forward gate remains unchanged. The forward capture boundary
...
post-capture timestamps while retaining old reports for replay acceptance.
