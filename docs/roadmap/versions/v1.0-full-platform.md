...
publication tests. It improves readiness for a future genuine XNAS paper session;
it does not satisfy the wall-clock forward-record gate or add historical publication
semantics.
