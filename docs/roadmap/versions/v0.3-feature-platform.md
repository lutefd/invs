...
- [ ] Add a read-only catalog coverage and lineage report.
...
discovery/lineage envelope. This does not claim the v0.3 exit gate, a coverage report,
or broad historical feature fitness.
...
- leaves read-side coverage/null reporting, automatic orphan repair, and independent
  child-artifact discovery outside the current boundary.
