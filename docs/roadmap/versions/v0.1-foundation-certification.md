...
- [x] Establish and observe the unattended daily runbook (`make daily` and
  `make ops-status`); the corrected 2026-08-13 run completed with
  `daily_status=ok` at `63d479d`.
- [x] Pass and record the v0.1 acceptance scenario in the
