...
- [x] Add durable-state reconciliation and operator guidance (`0f73e39`).
- [x] Prove backup and restore in a clean root (`0f73e39`, recovery drill).
- [ ] Establish and observe the unattended daily runbook (`make daily` and
  `make ops-status` are implemented; the 2026-08-13 observation recorded
  attention and a clean observation remains pending).
